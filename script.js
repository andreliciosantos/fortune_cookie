...
const p = document.querySelector("#randomPhrase");
...
const phrases = [
  ...
  'Não se desespere, dias melhores virão.',
  'O processo é pra te capacitar, não pra te fazer desistir.'
];
...
function generatePhrase() {
  ...
  p.innerText = phrases[randomPhrase];
};
...
cookie.addEventListener('click', generatePhrase);
btnRetry.addEventListener('click', toogleScreen);
